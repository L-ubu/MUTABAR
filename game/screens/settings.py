...
class SettingsScreen(Screen):
    ...
    def draw(self):
        ...
        self.buffer.write((W - 15) // 2, 1, "S E T T I N G S", t.accent_color)
        ...
        self.buffer.write(3, 4, f"{prefix} Theme", theme_color)
        self.buffer.write(5, 5, f"\u25c0 {theme_obj.display_name} \u25b6", t.text_color if self.row == 0 else t.dim_text_color)
        ...
        self.buffer.write(3, 7, f"{prefix_s} Sound", sound_color)
        self.buffer.write(5, 8, f"\u25c0 {sound_label} \u25b6", t.text_color if self.row == 1 else t.dim_text_color)

        self.buffer.write(1, 10, "\u2500" * (W - 2), t.border_color)
        self.buffer.write(3, 12, "\u2190\u2192 change  Enter apply", t.dim_text_color)
        self.buffer.write(3, 13, "ESC back", t.dim_text_color)
